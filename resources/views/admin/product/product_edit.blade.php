...
<div class="row-fluid">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            ...
            <a href="{{url('/admin/product/view/'.$product->id)}}" class=" btn btn-warning pull-right">
                <i class="icon-backward icon-white"></i>Back</a>
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form class="form-horizontal" name="updateform" action="{{route('product.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control{{ $errors->has('product_name') ? ' is-invalid' : '' }}" 
                                       name='product_name' value="{{$product->product_name}}" type="text" autofocus>
                                <input class="form-control{{ $errors->has('product_name') ? ' is-invalid' : '' }}" 
                                       name='product_id' value="{{$product->id}}" type="hidden" autofocus>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control{{ $errors->has('product_price') ? ' is-invalid' : '' }}" 
                                       name='product_price' value="{{$product->product_price}}" type="text" autofocus>
...
<script>
document.forms['updateform'].elements['publication_Status'].value = {{$product->publication_Status}};
document.forms['updateform'].elements['product_color'].value = {{$product->product_color}};
document.forms['updateform'].elements['product_category'].value = {{$product->product_category}};
