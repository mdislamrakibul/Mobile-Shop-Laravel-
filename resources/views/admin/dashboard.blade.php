        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="{{url('/admin/dashboard')}}">Admin Panel</a>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li class="active">
                            <a href="{{url('/admin/dashboard')}}"><i class="icon-chevron-right"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="{{route('category.list')}}"><i class="icon-chevron-right"></i> Phone Category</a>
                        </li>
                        <li>
                            <a href="{{route('product.list')}}"><i class="icon-chevron-right"></i> Products</a>
                        </li>
                        <li>
